export const sampleProducts = [
  {
    ...
    description: 'Premium wireless earbuds with active noise cancellation and 30-hour battery life. Crystal clear sound quality with deep bass.',
    images: [
    ...
    rating: 4.5,
    reviews: 328,
    features: ['Active Noise Cancellation', '30hrs Battery', 'Wireless Charging', 'IPX7 Waterproof']
  },
  {
    id: '2',
    ...
    discount: 25,
    category: 'Electronics',
    description: 'Advanced fitness tracking, heart rate monitoring, and seamless smartphone integration. Perfect for active lifestyles.',
    images: [
  ...
  },
  {
    ...
    rating: 4.3,
    reviews: 189,
    features: ['Adjustable Height', 'Aluminum Build', 'Heat Dissipation', 'Foldable Design']
  },
  {
    id: '4',
  ...
  },
  {
    ...
    discount: 31,
    category: 'Electronics',
    description: 'Premium mechanical gaming keyboard with customizable RGB lighting and tactile switches.',
    images: [
    ...
    rating: 4.8,
    reviews: 654,
    features: ['RGB Lighting', 'Mechanical Switches', 'Anti-Ghosting', 'Aluminum Frame']
  },
  {
    id: '6',
    ...
    discount: 33,
    category: 'Accessories',
    description: 'Ergonomic wireless mouse with precision tracking and comfortable grip for all-day use.',
    images: [
  ...
  },
  {
    ...
    discount: 37,
    category: 'Accessories',
    description: 'Genuine leather phone case with card slots and magnetic closure. Elegant and protective.',
    images: [
    ...
    rating: 4.5,
    reviews: 512,
    features: ['Genuine Leather', 'Card Slots', 'Magnetic Closure', 'Slim Design']
  },
  {
    id: '8',
    ...
    discount: 33,
    category: 'Electronics',
    description: 'Ultra-fast portable SSD with 1TB storage. USB-C 3.2 Gen 2 for blazing fast transfers.',
    images: [
