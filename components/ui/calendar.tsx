...
function Calendar({
  ...
  captionLayout = "label",
  ...props
}: CalendarProps & { buttonVariant?: "ghost" | "default" | "outline" | "secondary" | "destructive" | "link" }) {
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          buttonVariants({ variant: (props as any).buttonVariant || "ghost" }),
...
function CalendarDayButton({
  ...
  modifiers,
  ...props
}: React.ComponentProps<typeof Button> & { day: any; modifiers: any }) {
  const defaultClassNames = getDefaultClassNames()
